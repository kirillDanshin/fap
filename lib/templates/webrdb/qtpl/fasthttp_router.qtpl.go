...
//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:1
package qtpl
...
import (`)
	//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:3
	if packageName == "main" {
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:3
		qw422016.N().S(`
	"flag"
...
`)
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:6
	}
	//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:6
...
`)
	//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:11
	if packageName == "main" {
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:11
		qw422016.N().S(`
var (
	address = flag.String("address", "127.0.0.1:3270", "address to bind")
		...
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:14
	}
	//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:14
	qw422016.N().S(`

`)
	//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:16
	if packageName == "main" {
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:16
	...
	addr := *address
`)
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:19
	} else {
		//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:19
...
`)
//line lib/templates/fasthttprouter/qtpl/fasthttp_router.qtpl:31
}
